...
class DocumentWithoutSegments {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('customer_reviewer_email')) {
                obj['customer_reviewer_email'] = ApiClient.convertToType(data['customer_reviewer_email'], 'String');
            }
 ...
 * @member {String} customer_reviewer_email
 */
DocumentWithoutSegments.prototype['customer_reviewer_email'] = undefined;
