...
class CommentBody {
    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('isResolved')) {
                obj['isResolved'] = ApiClient.convertToType(data['isResolved'], 'String');
            }
        }
        return obj;
    }
 ...
 * @member {String} text
 */
CommentBody.prototype['text'] = undefined;

/**
 * A list of optional Annotations.
 * @member {Array.<module:model/Annotation>} annotations
 */
CommentBody.prototype['annotations'] = undefined;
 ...
 * @member {String} isResolved
 */
CommentBody.prototype['isResolved'] = undefined;
