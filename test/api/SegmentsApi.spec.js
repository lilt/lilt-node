...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltRestApi.SegmentsApi();
  });
  ...
  describe('SegmentsApi', function() {
    ...
    describe('tagSegment', function() {
      it('should call tagSegment successfully', function(done) {
        //uncomment below and update the code to test tagSegment
        //instance.tagSegment(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
