...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltRestApi.ProjectsApi();
  });
  ...
  describe('ProjectsApi', function() {
    ...
    describe('getProjectReport', function() {
      it('should call getProjectReport successfully', function(done) {
        //uncomment below and update the code to test getProjectReport
        //instance.getProjectReport(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
