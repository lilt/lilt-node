...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.SettingsApi();
  });
  ...
  describe('SettingsApi', function() {
    ...
    describe('upsertSetting', function() {
      it('should call upsertSetting successfully', function(done) {
        //uncomment below and update the code to test upsertSetting
        //instance.upsertSetting(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
