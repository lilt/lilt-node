...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.CommentsApi();
  });
  ...
  describe('CommentsApi', function() {
    ...
    describe('getDocumentComments', function() {
      it('should call getDocumentComments successfully', function(done) {
        //uncomment below and update the code to test getDocumentComments
        //instance.getDocumentComments(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
