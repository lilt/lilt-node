...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.SegmentCreateParameters();
  });
  ...
  describe('SegmentCreateParameters', function() {
    it('should create an instance of SegmentCreateParameters', function() {
      // uncomment below and update the code to test SegmentCreateParameters
      //var instane = new LiltNode.SegmentCreateParameters();
      //expect(instance).to.be.a(LiltNode.SegmentCreateParameters);
    });
