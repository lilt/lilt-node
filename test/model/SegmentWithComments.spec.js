...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.SegmentWithComments();
  });
  ...
  describe('SegmentWithComments', function() {
    it('should create an instance of SegmentWithComments', function() {
      // uncomment below and update the code to test SegmentWithComments
      //var instane = new LiltNode.SegmentWithComments();
      //expect(instance).to.be.a(LiltNode.SegmentWithComments);
    });
