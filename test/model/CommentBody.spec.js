...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.CommentBody();
  });
  ...
  describe('CommentBody', function() {
    it('should create an instance of CommentBody', function() {
      ...
      //var instane = new LiltNode.CommentBody();
      //expect(instance).to.be.a(LiltNode.CommentBody);
    });
    ...
    it('should have the property isResolved (base name: "isResolved")', function() {
