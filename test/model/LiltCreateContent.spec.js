...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.LiltCreateContent();
  });
  ...
  describe('LiltCreateContent', function() {
    it('should create an instance of LiltCreateContent', function() {
      // uncomment below and update the code to test LiltCreateContent
      //var instane = new LiltNode.LiltCreateContent();
      //expect(instance).to.be.a(LiltNode.LiltCreateContent);
    });
