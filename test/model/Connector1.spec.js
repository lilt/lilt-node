...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.Connector1();
  });
  ...
  describe('Connector1', function() {
    it('should create an instance of Connector1', function() {
      // uncomment below and update the code to test Connector1
      //var instane = new LiltNode.Connector1();
      //expect(instance).to.be.a(LiltNode.Connector1);
    });
