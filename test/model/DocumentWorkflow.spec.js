...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.DocumentWorkflow();
  });
  ...
  describe('DocumentWorkflow', function() {
    it('should create an instance of DocumentWorkflow', function() {
      // uncomment below and update the code to test DocumentWorkflow
      //var instane = new LiltNode.DocumentWorkflow();
      //expect(instance).to.be.a(LiltNode.DocumentWorkflow);
    });
    ...
    it('should have the property currentTask (base name: "currentTask")', function() {
      // uncomment below and update the code to test the property currentTask
      //var instane = new LiltNode.DocumentWorkflow();
      //expect(instance).to.be();
    });
