...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.AssignmentError();
  });
  ...
  describe('AssignmentError', function() {
    it('should create an instance of AssignmentError', function() {
      // uncomment below and update the code to test AssignmentError
      //var instane = new LiltNode.AssignmentError();
      //expect(instance).to.be.a(LiltNode.AssignmentError);
    });
