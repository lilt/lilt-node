...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.ProjectCreateParameters();
  });
  ...
  describe('ProjectCreateParameters', function() {
    it('should create an instance of ProjectCreateParameters', function() {
      // uncomment below and update the code to test ProjectCreateParameters
      //var instane = new LiltNode.ProjectCreateParameters();
      //expect(instance).to.be.a(LiltNode.ProjectCreateParameters);
    });
