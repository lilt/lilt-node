...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.MemoryCreateParameters();
  });
  ...
  describe('MemoryCreateParameters', function() {
    it('should create an instance of MemoryCreateParameters', function() {
      // uncomment below and update the code to test MemoryCreateParameters
      //var instane = new LiltNode.MemoryCreateParameters();
      //expect(instance).to.be.a(LiltNode.MemoryCreateParameters);
    });
