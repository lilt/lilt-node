...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.LiltCreateContentRequest();
  });
  ...
  describe('LiltCreateContentRequest', function() {
    it('should create an instance of LiltCreateContentRequest', function() {
      // uncomment below and update the code to test LiltCreateContentRequest
      //var instane = new LiltNode.LiltCreateContentRequest();
      //expect(instance).to.be.a(LiltNode.LiltCreateContentRequest);
    });
