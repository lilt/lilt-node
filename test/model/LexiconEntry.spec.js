...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltRestApi.LexiconEntry();
  });
  ...
  describe('LexiconEntry', function() {
    it('should create an instance of LexiconEntry', function() {
      // uncomment below and update the code to test LexiconEntry
      //var instane = new LiltRestApi.LexiconEntry();
      //expect(instance).to.be.a(LiltRestApi.LexiconEntry);
    });
