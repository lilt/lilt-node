...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LiltNode.ConnectorArguments();
  });
  ...
  describe('ConnectorArguments', function() {
    it('should create an instance of ConnectorArguments', function() {
      // uncomment below and update the code to test ConnectorArguments
      //var instane = new LiltNode.ConnectorArguments();
      //expect(instance).to.be.a(LiltNode.ConnectorArguments);
    });
