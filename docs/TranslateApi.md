...
# **registerSegment**
> Object registerSegment(source, srclang, trglang)
...
let apiInstance = new lilt.TranslateApi();
...
let opts = { 
  ...
  'n': 56, // Number | Return top n translations.
  'rich': true, // Boolean | Returns rich translation information (e.g., with word alignments).
 ...
 **n** | **Number**| Return top n translations. | [optional] 
